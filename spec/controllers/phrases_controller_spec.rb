...
RSpec.describe PhrasesController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new phrase" do

        post :create, params: {phrase: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(phrase_url(Phrase.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new phrase" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the phrase" do
        phrase = Phrase.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the phrase" do
        phrase = Phrase.create! valid_attributes
